...
<body class="flex overflow-hidden">
    <nav class="h-screen w-fit bg-gray-900 flex flex-col justify-end">
        ...
        <div class="mt-auto px-2 border-t-1 border-gray-700">
            ...
            <div class="text-red-400 border-1 border-red-500 rounded-[14px] flex justify-center mt-4 mb-4 p-1 cursor-pointer items-center duration-300 transition-all hover:bg-red-500 hover:text-black hover:border-red-500">
    ...
    <section id="#Home" class="h-screen w-screen bg-white-500 hidden">
    ...
    <section id="EmployeeList" class="w-screen h-screen">
        <div class="bg-gray-200 w-full h-fit p-3 shadow-xl border-b-1 border-gray-300 ">
            <div class="text-black font-bold flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 mr-2 ml-2 text-green-400">
                    <path d="M11.47 3.841a.75.75 0 0 1 1.06 0l8.69 8.69a.75.75 0 1 0 1.06-1.061l-8.689-8.69a2.25 2.25 0 0 0-3.182 0l-8.69 8.69a.75.75 0 1 0 1.061 1.06l8.69-8.689Z" />
        ...
        <div class="w-auto h-fit bg-gray-200 p-4 m-4 flex items-center rounded-3xl">
            ...
            <div class="flex items-center bg-blue-400  p-2 px-6 rounded-3xl cursor-pointer text-white duration-200 transition-all hover:bg-blue-700">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 mr-2">
